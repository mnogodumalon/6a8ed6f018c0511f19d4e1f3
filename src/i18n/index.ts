...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Auftragsmanagement Sanitär & Heizung",
    "apps": {
      "kunden": {
        "name": "Kunden",
        "app_id": "6a8ed6cbb1d157f8e9997679",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
      ...
      "monteure": {
        "name": "Monteure",
        "app_id": "6a8ed6d075d20d67cc53236c",
        "fields": {
          "monteur_vorname": "Vorname",
          "monteur_nachname": "Nachname",
          "monteur_telefon": "Telefonnummer"
        },
        "lookups": {}
      },
      "auftraege": {
        "name": "Aufträge",
        "app_id": "6a8ed6d0468c15ce34c9ce3f",
        "fields": {
          ...
          "plz": "Postleitzahl",
          "ort": "Ort",
          "baustelle_geo": "Standort der Baustelle",
      ...
      "baudokumentation": {
        ...
        "app_id": "6a8ed6d193452acde96bd5a4",
        "fields": {
          "auftrag": "Auftrag",
          "foto": "Foto der Baustelle",
          "notiz": "Kurze Notiz",
  ...
  "en": {
    "appgroup": "Order Management Plumbing & Heating",
    "apps": {
      "kunden": {
        "name": "Customers",
        "app_id": "6a8ed6cbb1d157f8e9997679",
      ...
      "monteure": {
        ...
        "app_id": "6a8ed6d075d20d67cc53236c",
        "fields": {
          "monteur_vorname": "First Name",
          "monteur_nachname": "Last Name",
          "monteur_telefon": "Phone Number"
        },
        "lookups": {}
      },
      "auftraege": {
        ...
        "fields": {
          ...
          "plz": "Postal Code",
          "ort": "City",
          "baustelle_geo": "Construction Site Location",
          "beschreibung": "What needs to be done?",
          "termin": "Preferred Date",
          "status": "Order Status"
        },
        "lookups": {
          "status": {
      ...
      "baudokumentation": {
        ...
        "fields": {
          "auftrag": "Order",
          "foto": "Photo of the Construction Site",
          "notiz": "Short Note",
          "aufnahmedatum": "Date of Recording"
        },
        "lookups": {}
      }
    }
